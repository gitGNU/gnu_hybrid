...
#define VGA_BASE             CONFIG_VGA_DEBUGGER_BASE
#define VGA_COLUMNS          CONFIG_VGA_DEBUGGER_COLUMNS
#define VGA_ROWS             CONFIG_VGA_DEBUGGER_ROWS

RESOURCE_DECLARE(vga_mem,"VGA Memory",RSRC_MEM,                               \
                 CONFIG_VGA_DEBUGGER_BASE,                                    \
                 (CONFIG_VGA_DEBUGGER_BASE + (CONFIG_VGA_DEBUGGER_COLUMNS *   \
                                              CONFIG_VGA_DEBUGGER_ROWS * 2)));

RESOURCE_DECLARE(vga_io,"VGA I/O",RSRC_IO,VGA_COMMAND_PORT,VGA_DATA_PORT);
