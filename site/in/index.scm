(h3 "DESCRIPTION")
(p
 "Hybrid is a kernel being developed with an emphasis on design and "
 ...
 (br)
 (br)
 "The kernel is under heavy development and is not yet usable, from the user "
 "point of view.")
...
(p
 ...
 (br)
 (br)
 "The Intel IA-32 (x86) supports the following features/hardware (not "
 "updated):")
(ul
 (li "IDT / GDT")
 (li "PIT (i8253)")
...
(h3 "REPORT A BUG")
(p
 "If you think you have found a bug in Hybrid then please send as complete "
 "a report as possible to <hybrid AT nongnu DOT org>. An easy way to collect "
 "all the required information, such as platform and compiler, is to include "
